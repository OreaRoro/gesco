...
import { FaSave, FaMoneyBillWave, FaExclamationTriangle } from "react-icons/fa";
...
const InscriptionForm: React.FC = () => {
  ...
  const onSubmit = async (formData: InscriptionFormData) => {
    ...
    setLoading(true);
    try {
      const inscriptionData: InscriptionCreateRequest = {
      ...
      const errorMessage =
        error.response?.data?.messages?.error || "Erreur lors de l'inscription";
  ...
  return (
    <>
      <PageMeta
        title={`Inscrire ${eleve.prenom} ${eleve.nom} | Système de Gestion Scolaire`}
        description={`Formulaire d'inscription pour ${eleve.prenom} ${eleve.nom}`}
      />

      <PageBreadcrumb
        pageTitle={`Inscrire ${eleve.prenom} ${eleve.nom}`}
        breadcrumbs={[
          { label: "Dashboard", path: "/" },
          { label: "Élèves", path: "/eleves" },
          { label: `${eleve.prenom} ${eleve.nom}`, path: `/eleves/${id}` },
          { label: "Nouvelle Inscription", path: `/eleves/${id}/inscrire` },
        ]}
      />
      ...
      <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div>
                <h3 className="font-medium text-blue-900">
                  Inscription pour l'année scolaire {anneeActive.annee}
                </h3>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            <ComponentCard title="Formulaire d'Inscription">
              <form
            ...
            <ComponentCard title="Informations Importantes">
              <div className="space-y-3 text-sm text-gray-600">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <p>L'élève sera marqué comme "Actif" après l'inscription.</p>
                </div>

                <div className="flex items-start gap-2">
                  <div className="w-2 h-2 mt-1.5 bg-blue-500 rounded-full"></div>
                  <p>Un email de confirmation sera envoyé aux parents.</p>
                </div>
              </div>
            </ComponentCard>
